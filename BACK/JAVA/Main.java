...
//            br.put("박세욱", "피냐콜라다"); // 기존값에서 대체
//            System.out.println(br.get("이순자"));
//        }
    // keySet ex)
//  public class Main {
//    public static void main(String[] args) {
...
//        br.put("이순자", "아몬드봉봉");
//        br.put("박세욱", "체리쥬빌레");
//        Set<String> names = br.keySet();
//        for (String name : names) {
//            System.out.println(String.format("%s : %s", name, br.get(name)));
//        }
//    }

    // 전달받은 가변인자 nums(int[])이 가지고 있는 정수 중 소수(Prime Number)인 것만 인자로 가지는
    // List<Integer> 객체를 반환하세요. 단, nums의 인자는 1이상의 수만 가진다.
    // 소수는 어떠한 자연수 x에 대해 이를 나누어 떨어지게 할수 있는 자연수가 1과 x뿐인 수를 의미합니다.
//    public static List<Integer> filterPrimes(int...nums) {
...
//        return answer;
//    }
    // 전달받은 가변인자 nums(int[])이 가지고 있는 정수 중 양수이면서 홀수인 것만 인자로 가지는 List<Integer>객체를 반환하시오
//    public static List<Integer> filterOdds(int...nums) {
//        List<Integer> answer= new ArrayList<>();
//        for (int i = 0; i < nums.length; i++) {
